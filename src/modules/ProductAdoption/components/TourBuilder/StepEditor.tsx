...
import { TourStep, TourAction } from '../../types';
...
export const StepEditor: React.FC<StepEditorProps> = ({ step, onChange }) => {
    ...
    <div className="step-editor">
      ...
      <div className="step-editor-content">
        <TabView activeIndex={activeTab} onTabChange={(e) => setActiveTab(e.index)}>
          <TabPanel header="Content" leftIcon="pi pi-file-edit">
            <div className="p-fluid">
              ...
              <div className="p-field">
                <div className="content-editor-header">
                  ...
                  />
                  <label htmlFor="use-rich-text" className="rich-text-toggle">
          ...
          <TabPanel header="Targeting" leftIcon="pi pi-crosshairs">
            <div className="p-fluid">
              <div className="p-field">
                ...
                <small className="p-text-secondary mt-2">
                  Select an element on the page or enter a CSS selector. Leave empty for centered modal.
                </small>
              </div>
                  ...
                  <div className="p-col-6">
                    <div className="p-field">
                      ...
                      <InputNumber
                        ...
                        onChange={(e) => onChange({ spotlightRadius: e.value || 0 })}
                        min={0}
                        suffix=" px"
                      />
                    </div>
                  ...
                  <div className="p-col-6">
                    <div className="p-field">
                      ...
                      <InputNumber
                        ...
                        onChange={(e) => onChange({ spotlightPadding: e.value || 0 })}
                        min={0}
                        suffix=" px"
                      />
                    </div>
          ...
          <TabPanel header="Actions" leftIcon="pi pi-directions">
            <div className="p-fluid">
              <div className="p-field">
                <div className="p-field-checkbox">
                  ...
                  />
                  <label htmlFor="step-skipable">Allow users to skip this step</label>
                </div>
              </div>
          ...
          <TabPanel header="Styling" leftIcon="pi pi-palette">
            <div className="p-fluid">
              <div className="p-field">
                <label>Custom Styles (Advanced)</label>
                <InputTextarea
                  value={step.customStyles ? JSON.stringify(step.customStyles, null, 2) : ''}
                  onChange={(e) => {
                    try {
                      const styles = e.target.value ? JSON.parse(e.target.value) : undefined;
  ...
  "fontSize": "16px"
          ...
          <TabPanel header="Conditions" leftIcon="pi pi-filter">
            <div className="p-fluid">
              <div className="p-field">
