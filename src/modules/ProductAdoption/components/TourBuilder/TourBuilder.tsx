...
import { Tour, TourStep, TourSettings, TourTargeting, TourTrigger } from '../../types';
    ...
    <div className="tour-builder">
      ...
      <div className="tour-builder-content">
          ...
          <div className="p-fluid">
            ...
            <div className="p-field">
              ...
              <Dropdown
                ...
                onChange={(e) =>
                  setTourData({ ...tourData, status: e.value })
                }
              />
            </div>
          </div>
        ...
        <TabView activeIndex={activeTab} onTabChange={(e) => setActiveTab(e.index)}>
          <TabPanel header="Steps" leftIcon="pi pi-list">
            <div className="tour-steps-container">
                      ...
                      <div className="step-item-header">
                        ...
                        <div className="step-item-actions">
                          ...
                          <Button
                            ...
                            disabled={index === (tourData.steps?.length || 0) - 1}
                          />
                          <Button
                            icon="pi pi-copy"
                            className="p-button-text p-button-sm"
              ...
              {selectedStepId && (
                <div className="step-editor-container">
                  <StepEditor
                    step={tourData.steps?.find((s) => s.id === selectedStepId)!}
                    onUpdate={(updates) =>
          ...
          <TabPanel header="Triggers" leftIcon="pi pi-bolt">
            <TourTriggers
              trigger={tourData.trigger || { type: 'manual' }}
              onChange={(trigger) =>
                setTourData({ ...tourData, trigger })
              }
            />
          </TabPanel>

          <TabPanel header="Targeting" leftIcon="pi pi-users">
            <TourTargetingComponent
              targeting={tourData.targeting!}
              onChange={(targeting) =>
                setTourData({ ...tourData, targeting })
              }
            />
          </TabPanel>
